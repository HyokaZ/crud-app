...
@Component({
  selector: 'app-emp-popup',
  templateUrl: './emp-popup.component.html',
  styleUrls: ['./emp-popup.component.scss']
})
export class EmpPopupComponent {
  ...
  save() {
    ...
    if (this.form.valid) {
      if (this.form.value.id > 0) {
        this.http.put(`${this.service.url}edit_employee/${this.form.value.id}`, this.form.value).subscribe((response: any) => {
        ...
        this.http.post(`${this.service.url}add_employee`, this.form.value).subscribe((response: any) => {
